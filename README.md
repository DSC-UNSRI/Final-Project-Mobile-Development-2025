...
- [GreenTasker-Bintara/README.md](GreenTasker-Bintara/README.md) — GreenTasker by [Ahmad Bintara Mansur](https://github.com/jazhardcore7)  
    SDG: 13 — Climate Action  
    Gamified eco-quests where users complete sustainability tasks, upload proof photos and earn XP to level up.

- [EcoTrack-Dayana/README.md](EcoTrack-Dayana/README.md) — EcoTrack by [Dayana Khoiriyah Harahap](https://github.com/Dayana-K-H)  
    SDG: 12 — Responsible Consumption and Production  
    Tracks users' consumption habits and provides eco-feedback and history for sustainable choices.

- [ForgetMeNot-Fachry/README.md](ForgetMeNot-Fachry/README.md) — ForgetMeNot by [Fachry Ghifary](https://github.com/githubbingry)  
...
- [NutriSight-Abel/README.md](NutriSight-Abel/README.md) — NutriSight by [Farhan Abel Rantisi](https://github.com/FarhanAbelRantisi)  
...
- [LinguaPanel-Haikal/README.md](LinguaPanel-Haikal/README.md) — LinguaPanel by [M Haikal Ash Shiddiq](https://github.com/FrxHaikalPlg)  
...
- [EspressYoSelf-Rizki/README.md](EspressYoSelf-Rizki/README.md) — Espress Yo Self by [M. Rizki Sepriadi](https://github.com/rizkisepriadi)  
    SDG: 12, SDG 3 & SDG 13 — Responsible Consumption, Good Health & Well‑Being, Climate Action  
    Coffee shop loyalty & rewards app with QR scanning, eco-bonuses and a digital stamp/rewards system. See contributing notes at [EspressYoSelf-Rizki/CONTRIBUTING.md](EspressYoSelf-Rizki/CONTRIBUTING.md).

- [HabiVault-Arief/README.md](HabiVault-Arief/README.md) — HabiVault by [Muhammad Arief Pratama](https://github.com/ariefff666)  
...
- [GymBros-Suheil/README.md](GymBros-Suheil/README.md) — GymBros by [Muhammad Suheil Ichma Putra](https://github.com/MuhammadSuheil)  
    SDG: 3 — Good Health & Well‑Being  
    Cross-platform workout tracker to log exercises, sets, reps and visualize progress with history and analytics.

- [BluBlu-Najwa/README.md](BluBlu-Najwa/README.md) — BluBlu by [Najwa Ainayah](https://github.com/najwaainayah)  
...
- [Askmedia-Syakillah/README.md](Askmedia-Syakillah/README.md) — Askmedia (Askademia) by [Syakillah Nachwa](https://github.com/Chwakillah)  
    SDG: 4 — Quality Education  
...
2. Open the submodule folder you want to work on in your editor (for example, VS Code):  
   - [GymBros-Suheil/README.md](GymBros-Suheil/README.md)  
   - [EspressYoSelf-Rizki/README.md](EspressYoSelf-Rizki/README.md)  
